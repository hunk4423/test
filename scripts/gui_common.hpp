...
class Life_RscTree {
	...
	expandedTexture = "scripts\guiexpandedTexture_ca.paa";
	hiddenTexture = "scripts\guihiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "scripts\guinormal_ca.paa";
	animTextureNormal = "scripts\guinormal_ca.paa";
	animTextureDisabled = "scripts\guinormal_ca.paa";
	animTextureOver = "scripts\guiover_ca.paa";
	animTextureFocused = "scripts\guifocus_ca.paa";
	animTexturePressed = "scripts\guidown_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "scripts\guiconfig\guimain\normal_ca.paa";
	animTextureDisabled = "scripts\guiconfig\guimain\disabled_ca.paa";
	animTextureOver = "scripts\guiconfig\guimain\over_ca.paa";
	animTextureFocused = "scripts\guiconfig\guimain\focus_ca.paa";
	animTexturePressed = "scripts\guiconfig\guimain\down_ca.paa";
	animTextureDefault = "scripts\guiconfig\guimain\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class Life_RscListBox 
{
	...
	arrowFull = "scripts\guiarrowFull_ca.paa";
	arrowEmpty = "scripts\guiarrowEmpty_ca.paa";
	wholeHeight = 0.45;
	rowHeight = 0.04;
	color[] = {0.7, 0.7, 0.7, 1};
	colorActive[] = {0,0,0,1};
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "scripts\guiconfig\guislider\arrowEmpty_ca.paa";
	arrowFull = "scripts\guiconfig\guislider\arrowFull_ca.paa";
	border = "scripts\guiconfig\guislider\border_ca.paa";
	thumb = "scripts\guiconfig\guislider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "scripts\guiconfig\guiarrow_left_ca.paa";
	nextPage = "scripts\guiconfig\guiarrow_right_ca.paa";
	shadow = 2;
...
class Life_RscCombo {
	...
	arrowFull = "scripts\guiconfig\guiarrowFull_sca.paa";
	arrowEmpty = "scripts\guiconfig\guiarrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
	colorDisabled[] = {1, 1, 1, 0.25};
...
class Zupa_RscButton {
	...
	{
		left = 0;
		top = "(((((safezoneW/safezoneH) min 1.2)/1.2)/20)-((((safezoneW/safezoneH) min 1.2)/1.2)/25))/2";
		w = "(((((safezoneW/safezoneH) min 1.2)/1.2)/25)*1)*(3/4)";
		h = "(((((safezoneW/safezoneH) min 1.2)/1.2)/25)*1)";
	};
	class TextPos
...
#define HEADERBGRCOLOR	{"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])","(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])","(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])","(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])"}

class DialogTitle: Life_RscTitle{moving=1;colorBackground[]=HEADERBGRCOLOR;};
class StatusT: RscTextT {colorBackground[]={0,0,0,0.8};colorText[]={1,1,1,1};};
class HeaderT: Life_RscText {idc=-1;colorBackground[]=HEADERBGRCOLOR;ctrlSize(0.13,0.03);};
class TitleT: Life_RscText {idc=-1;};
class DialogBackground: RscTextT {colorBackground[]={0,0,0,0.8};};
class TextEdit: Life_RscEdit {colorText[]={0.8784,0.8471,0.651,1};sizeEx=0.03;text="";};
class ListBox: RscListbox {sizeEx=0.04;colorBackground[]={0.1,0.1,0.1,0.2};};
class GkFrame {
	type=0;idc=-1;style=64;shadow=2;colorBackground[]={0,0,0,0};
	colorText[]=HEADERBGRCOLOR;font="Zeppelin32";sizeEx=0.028;
};
