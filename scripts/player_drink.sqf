...
private ["_megastrong","_hndl","_drunkenness","_onLadder","_itemorignal","_hasdrinkitem","_hasoutput","_config","_text","_sfx","_dis","_itemtodrop","_nearByPile","_item","_display","_invehicle","_started","_finished","_isDrink","_iPos","_myDrink"];
...
if (["ItemWaterbottle",_itemorignal] call fnc_inString) then {
	...
	[200+(random 200)] spawn fnc_usec_addBlood;	
};
...
if (["ItemSodaR",_itemorignal] call fnc_inString) then {
	[500+(random 300)] spawn fnc_usec_addBlood;	
};  
...
if ((RND(40)) and (_itemorignal == "ItemWaterbottle")) then {
