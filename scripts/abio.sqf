...
private ["_AbioLastUsedTime","_overdose","_AbioTime","_overdose","_heartbeat_1","_rBlood","_hndl","_heartbeat2"];
_AbioLastUsedTime = 60;
_overdose = false;
if (isNil "lastAbio") then {lastAbio = 0;};
_AbioTime = time - lastAbio;
if (_AbioTime < _AbioLastUsedTime) then { _overdose = true;};
