class VehicleColourDialog
{
	...
	class RscStructuredText_110:RscStrText
	{
		...
		y = 0.610074074074074 * safezoneH + safezoneY;
		w = 0.2 * safezoneW;
		h = 0.0592592592592593 * safezoneH;
		colorBackground[]= {0,0,0,0};
	};
	
		class RscStructuredText_111:RscStrText
	{
		idc = 5705;
		text = "";
	...
	class RscShortcutButton_172:RscScButton
	{
		idc=-1;
		text= "Предпросмотр";
		...
		w = 0.11 * safezoneW;
		h = 0.07 * safezoneH;
		onButtonClick = "call VehicleColourPreview; ((ctrlParent (_this select 0)) closeDisplay 9000);";
	};
	
	class RscShortcutButton_173:RscScButton
	{
		idc=-1;
		text= "Стандарт";
		...
		w = 0.09 * safezoneW;
		h = 0.07 * safezoneH;
		onButtonClick = "call VehicleColourDefalt; ((ctrlParent (_this select 0)) closeDisplay 9000);";
	};
