...
class SellHumanityDialog
{
	...
	class Controls {
		...
		class DepositButton2 : life_RscButtonMenu 
		{
			...
			onButtonClick = "[(ctrlText 14500)] spawn OnSellHumanityClick; ((ctrlParent (_this select 0)) closeDisplay 9000);";
			colorText[] = {0.8784,0.8471,0.651,1};
			x = 0.432;
			y = 0.512;
			w = (6 / 40);
