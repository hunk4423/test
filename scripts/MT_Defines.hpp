class Custom_Buildables { class Buildables{
	class Default {
	...
	class Default30mPlot:Default {
		offset[]={0,2,1};	
		requiredtools[] = {"ItemToolbox","ItemSledge","ItemCrowbar"};
		requiredmaterials[] ={"30m_plot_kit"};
	};
	...
	class DefaultFlag:Default {
		...
		requiredmaterials[] ={"ItemSapphire","ItemPole","ItemPole","ItemPole","ItemCanvas","ItemSodaClays"};
	};
	class DefaultBeds:Default {
		offset[]={0,2,0};
		requiredtools[] = {"ItemToolbox","ItemHatchet_DZE","ItemKnife"};
		requiredmaterials[] ={"ItemRuby","PartPlankPack","PartPlywoodPack","ItemGoldBar10oz","ItemGoldBar10oz","ItemGoldBar10oz"};
	};	
	...
	class DefaultWindows:Default {
		offset[]={0,2,0};
		requiredtools[] = {"ItemToolbox","ItemCrowbar"};		
		requiredmaterials[] ={"ItemCitrine","ItemSandbag","ItemSandbag"};
	};
	...
	class DefaultElectronics:Default {
		offset[]={0,2,1};
		requiredtools[] = {"ItemToolbox"};		
		requiredmaterials[] ={"ItemSapphire","PartGeneric","PartGeneric"};
	};	
	...
	class DefaultPictures:Default {
		offset[]={0,2,1};
		requiredtools[] = {"ItemToolbox","ItemHatchet_DZE","ItemKnife"};		
		requiredmaterials[] ={"ItemSapphire","PartPlankPack"};
	};		
	class DefaultLightbulbs:Default {
		offset[]={0,2,1};
		requiredtools[] = {"ItemToolbox"};
		requiredmaterials[] ={"ItemRuby","ItemLightBulb","ItemGoldBar10oz","ItemGoldBar10oz"};
	};
	class DefaultLightPoles:Default {
		offset[]={0,3,5};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemRuby","ItemLightBulb","bulk_PartGeneric","ItemPole","ItemPole","ItemPole"};
	};
	class DefaultLightFixtures:Default {
		offset[]={0,2,1};
		requiredtools[] = {"ItemToolbox"};
		requiredmaterials[] ={"ItemRuby","ItemLightBulb","PartGeneric","PartGeneric"};
	};	
	...
	class DefaultSignsMiscCool:Default {
	offset[]={0,3,1};	
	requiredtools[] = {"ItemToolbox","ItemSledge"};
	requiredmaterials[] ={"ItemAmethyst","ItemPole","ItemPole","PartGeneric","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz"};
	};	
	class DefaultBarrel:Default {
	offset[]={0,3,1};	
	requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};
	requiredmaterials[] ={"ItemTopaz","bulk_PartGeneric"};
	};	
	class DefaultBarrels:Default {
	offset[]={0,3,1};	
	requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};
	requiredmaterials[] ={"ItemTopaz","bulk_PartGeneric","bulk_PartGeneric","bulk_PartGeneric"};
	};		
	...
	class DefaultTentsS:Default {
		offset[]={0,6,1};
		requiredtools[] = {"ItemToolbox","ItemKnife"};		
		requiredmaterials[] ={"ItemObsidian","ItemSodaClays"};
	};
	...
	//48
	class Defenses{		//26	
	class Sandbag1_DZ:Default {
		displayName="Мешок с песком";
		offset[]={0,5,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","ItemSandbag"};
	};		
	class BagFenceRound_DZ:Default {
		displayName="Круговой мешок с песком";
		offset[]={0,5,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","BagFenceRound_DZ_kit"};
	};		
	class Fort_RazorWire:Default {
		displayName="Колючая проволока";
		offset[]={0,5,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","ItemWire"};
	};	
	class Hedgehog_DZ:Default {
		displayName="Противотанковый еж";
		offset[]={0,5,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","ItemTankTrap"};
	};	
	class StickFence_DZ:Default {
		displayName="Забор из веток";
		offset[]={0,5,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","stick_fence_kit"};
	};	
	
	class Hhedgehog_concrete:Default {
		offset[]={0,7,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","CinderBlocks","CinderBlocks","CinderBlocks","MortarBucket","MortarBucket"};
	};	
	...
	class Land_CncBlock_Stripes:Default {
		offset[]={0,4,1};
		requiredtools[] = {"ItemToolbox","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemTopaz","CinderBlocks","CinderBlocks","CinderBlocks","CinderBlocks","CinderBlocks"};
		};
	...
	class Wells{			//5
	class MAP_barrel_water:DefaultWells {};
	...
	class Land_Ind_TankSmall2_EP1:Default {
		offset[]={0,5,1};	
		requiredmaterials[] ={"ItemTopaz","ItemSodaClays"};		
		requiredtools[] = {"ItemToolbox","ItemCrowbar"};	
	};
	...
	class Land_wagon_tanker:Default {
		offset[]={0,7,1};	
		requiredmaterials[] ={"ItemTopaz","ItemSodaClays"};		
		requiredtools[] = {"ItemToolbox","ItemCrowbar"};	
	};
	...
	class MAP_Stan_east:Default {
		offset[]={0,10,2};
		requiredtools[] = {"ItemToolbox","ItemEtool","ItemKnife","ItemHatchet_DZE"};		
		requiredmaterials[] ={"ItemObsidian","ItemSodaClays","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz"};
	};
	class MAP_Stan:Default {
		offset[]={0,6,1};
		requiredtools[] = {"ItemToolbox","ItemKnife"};		
		requiredmaterials[] ={"ItemObsidian","ItemCanvas","ItemCanvas","ItemCanvas","ItemPole","ItemPole","ItemPole","bulk_ItemSandbag"};
	};	
	class MAP_tent_small_west:Default {
		offset[]={0,6,1};
		requiredtools[] = {"ItemToolbox","ItemKnife"};		
		requiredmaterials[] ={"ItemObsidian","ItemCanvas","ItemCanvas","ItemCanvas","ItemPole","ItemPole","ItemPole"};
	};
	class Land_fort_rampart_EP1:Default {
		offset[]={0,8,1};
		requiredtools[] = {"ItemToolbox","ItemHatchet_DZE","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemObsidian","PartPlankPack","PartPlankPack"};
	};
	...
	class MAP_fortified_nest_small:Default {
		...
		requiredmaterials[] ={"ItemObsidian","bulk_ItemSandbag","bulk_ItemSandbag","PartPlankPack","PartPlankPack","ItemCanvas"};
		};	
	...
	class MAP_GuardShed:Default {
		offset[]={0,8,2};
		requiredtools[] = {"ItemToolbox","ItemHatchet_DZE","ItemKnife"};		
		requiredmaterials[] ={"ItemObsidian","PartPlankPack","PartPlankPack","PartPlankPack"};		
	};	
	class MAP_Fortress_02:Default {
		offset[]={0,10,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemObsidian","bulk_ItemSandbag","bulk_ItemSandbag","bulk_ItemSandbag","bulk_ItemSandbag","PartPlankPack","ItemCanvas","ItemCanvas"};
		};	
	class MAP_Fortress_01:Default {
		offset[]={0,8,1};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemEtool","ItemSledge"};
		requiredmaterials[] ={"ItemObsidian","bulk_ItemSandbag","bulk_ItemSandbag","PartPlankPack","ItemCanvas"};
		};	
	...
	class Pipeline{
		class Land_IndPipe2_big_9:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
		};			
		class Land_IndPipe2_big_18:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
		};
		...
		class Land_IndPipe2_bigL_R:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
		};			
		class Land_IndPipe2_bigBuild1_R:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
		};
		class Land_IndPipe2_bigBuild1_L:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
		};			
		class Land_IndPipe2_big_ground1:Default {
			offset[]={0,5,2};
			requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
			requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit"};
		};
	};	
	class CargoContainers{     	//16
		class Land_Misc_Cargo1E_EP1:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class Land_Misc_Cargo1Eo_EP1:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class Land_Misc_Cargo2E:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class Land_Misc_Cargo2E_EP1:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class Misc_Cargo1B_military:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class MAP_Misc_cargo_cont_tiny:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class MAP_Misc_cargo_cont_small2:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
		class MAP_Misc_cargo_cont_small:Default {
		offset[]={0,5,2};
		requiredtools[] = {"ItemToolbox","ItemCrowbar","ItemSledge"};		
		requiredmaterials[] ={"ItemEmerald","bulk_PartGeneric","metal_floor_kit","metal_floor_kit","metal_floor_kit"};
	};	
	...
	class ZavoraAnim:DefaultEmerald {};
	...
	//Гараж
	class VGarage{
		class MAP_phone_box:Default30mPlot {displayName="Гараж (телефонная будка)";};
		class MAP_phonebox:Default30mPlot {displayName="Гараж (телефон-автомат)";};	
	};
	class HPad{
		class MAP_Heli_H_army:DefaultHelipads {displayName="Площадка военная";};	
		class MAP_Heli_H_cross:DefaultHelipads {displayName="Площадка крест";};
		class HeliH:DefaultHelipads {displayName="Площадка вертолетная";};
		class HeliHEmpty:DefaultHelipads {
			offset[]={0,3,.73};	
			requiredtools[] = {"ItemToolbox","ItemSledge","ItemCrowbar"};
			requiredmaterials[] ={"30m_plot_kit","ItemBriefcase100oz"};	
			displayName="Площадка невидимая";
		};
	};
	class DHpad{
		class HeliHCivil:Default {
			offset[]={0,3,.73};
			requiredtools[] = {"ItemToolbox","ItemSledge","ItemCrowbar"};
			requiredmaterials[] ={"30m_plot_kit","ItemSodaClays"};		
			displayName="Площадка гражданская";
		};
		class Sr_border:Default {
			offset[]={0,3,.73};		
			requiredtools[] = {"ItemToolbox","ItemSledge","ItemCrowbar"};
			requiredmaterials[] ={"30m_plot_kit","ItemSodaClays"};
			displayName="Площадка прямоугольная";
		};		
		class HeliHRescue:Default {
			offset[]={0,3,.73};		
			requiredtools[] = {"ItemToolbox","ItemSledge","ItemCrowbar"};
			requiredmaterials[] ={"30m_plot_kit","ItemSodaClays"};
			displayName="Эвакуационная площадка";
		};
	};
	...
	class MAP_leseni2x:Default {
		offset[]={0,3,1.5};
		requiredtools[] = {"ItemToolbox","ItemCrowbar"};		
		requiredmaterials[] ={"ItemEmerald","ItemPole","ItemPole","ItemPole","ItemPole","ItemPole","PartPlankPack","PartPlankPack","ItemBriefcase100oz","ItemBriefcase100oz"};
		};
	class MAP_leseni4x:Default {
		offset[]={0,3,3.5};
		requiredtools[] = {"ItemToolbox","ItemCrowbar"};		
		requiredmaterials[] ={"ItemEmerald","ItemPole","ItemPole","ItemPole","ItemPole","ItemPole","PartPlankPack","PartPlankPack","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz"};
		};
	};
	class Sunshades{           	//15
	...
	class Sign_Danger:Default {
	offset[]={0,3,1};	
	requiredtools[] = {"ItemToolbox","ItemHatchet_DZE"};		
	requiredmaterials[] ={"ItemAmethyst","PartPlywoodPack","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz"};
	};		
	...
	class MAP_sign_danger_mines:DefaultSignsMiscCool {};
	class MAP_sign_danger1:DefaultSignsMisc {};
	class Sign_1L_Firstaid:DefaultSignsMiscCool {};
	class Sign_1L_Firstaid_EP1:DefaultSignsMiscCool {};
	};
	...
	class MAP_sign_danger:DefaultSignsMiscCool {};
	...
	class MAP_sign_stop_new:DefaultSignsMiscCool {};
	...
	class MAP_fort_watchtower:Default {
		offset[]={0,10,2};
        requiredtools[] = {"ItemEtool","ItemToolbox","ItemCrowbar","ItemSledge"};	
		requiredmaterials[] ={"ItemObsidian","ItemSodaClays","bulk_PartGeneric"};
 	};
	...
	class Benches{     			//8
	class Bleacher_EP1:Default {
	offset[]={0,3,1};
	requiredtools[] = {"ItemToolbox","ItemHatchet_DZE","ItemKnife"};		
	requiredmaterials[] ={"ItemRuby","PartPlankPack","PartPlankPack","PartPlankPack","PartPlankPack","ItemPole","ItemPole","ItemPole"};	
	};			
	...
	class Windows{   	//6   
	class MAP_HouseV2_02_window:DefaultAppliances {};
	class MAP_P_DoorGlass:DefaultAppliances {};
	class MAP_P_WindowSmall:DefaultAppliances {};	
	class MAP_P_WindowLarge:DefaultAppliances {};
	class MAP_P_WindowHall:DefaultAppliances {};
	};
	class Bathroom{       	//7
	...
	class MAP_notebook:Default {offset[]={0,2,1};displayName="Интернет-магазин";requiredtools[]={"ItemToolbox"};requiredmaterials[]={"ItemSapphire"};};
	class MAP_PowerGenerator:Default	{
		offset[]={0,3,1};
		displayName="Бесшумный генератор";
		requiredtools[] = {"ItemToolbox"};		
		requiredmaterials[] ={"ItemSapphire","ItemBriefcase100oz","ItemGenerator","bulk_PartGeneric","PartEngine","PartFueltank"};		
	};	
	class MAP_misc_videoprojector:DefaultElectronics {displayName="Проектор";};
	class MAP_misc_videoprojector_platno:DefaultElectronics {displayName="Экран проектора";};
	class MAP_mutt_vysilacka:DefaultElectronics {displayName="Радиостанция";};
	class MAP_pc:DefaultElectronics {displayName="Компьютер";};
	class MAP_radio_b:DefaultElectronics {displayName="Радио";};
	class MAP_satelitePhone:Default {
		offset[]={0,2,1};displayName="Спутниковый телефон";
		requiredtools[] = {"ItemToolbox"};
		requiredmaterials[] ={"ItemSapphire","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz","ItemBriefcase100oz"};
	};	
	class MAP_tv_a:DefaultElectronics {displayName="Телевизор ЭЛТ";};
	class Radio:DefaultElectronics {displayName="Радио";};
	...
	//33
	class Lightbulbs{     	//10
	class ASC_EU_BulbI:DefaultLightbulbs {};	
