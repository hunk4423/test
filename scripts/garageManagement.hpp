class GarageManagement:AccessManagement {
	...
	class Controls : Controls {
		...
		class PlayerBTN: AccessBTN {
			idc = 7020;
			y=SY(0.36);
			onButtonClick = "[0] call OnAccessChange";
		};
		class OtherBTN: AccessBTN {
			idc = 7021;
			y=SY(0.4);
			onButtonClick = "[1] call OnAccessChange";
		};
		class SelfBTN: AccessBTN {
			idc = 7022;
			y=SY(0.44);
			onButtonClick = "[2] call OnAccessChange";
		};
	};
};
