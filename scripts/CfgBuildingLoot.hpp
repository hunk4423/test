...
class CfgBuildingLoot {
	...
	class Industrial: Default {
		...
		lootType[] = {
			{"","industrialloot",0.5},
			{"","military",0.02},
			{"WeaponHolder_ItemHatchet_DZE","object",0.03},
	...
	class Farm: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{"ItemJerrycan","magazine",0.0025},
			{"ItemJerrycanEmpty","magazine",0.0025},
			{"","generic",0.3},
			{"","trash",0.11},
	...
	class MilitaryIndustrial: Default {
		...
		lootType[] = {
			...
			{"PartGeneric","magazine",0.02},
			{"PartWheel","magazine",0.03},
			{"PartFueltank","magazine",0.02},
			{"PartEngine","magazine",0.02},
			{"PartGlass","magazine",0.02},
			{"PartVRotor","magazine",0.03},
			{"ItemJerrycan","magazine",0.01},
			{"ItemJerrycanEmpty","magazine",0.01},
			...
			{"ItemEtool","weapon",0.03},
			{"fuel_pump_kit","magazine",0.01},
			{ "machineguns", "cfglootweapon", 0.02 }
		};
		lootTypeSmall[] = {
			{ "pistols", "cfglootweapon", 0.14 },
			{"ItemSandbag","magazine",0.01},
	...
	class IndustrialMilitary: Default {
		...
		lootType[] = {
			...
			{"ItemGenerator","magazine",0.01},
			{"PartGeneric","magazine",0.08},
			{"PartWheel","magazine",0.03},
			{"PartFueltank","magazine",0.04},
			{"PartEngine","magazine",0.04},
			{"PartGlass","magazine",0.09},
			{"PartVRotor","magazine",0.04},
			{"ItemJerrycan","magazine",0.03},
			{"ItemJerrycanEmpty","magazine",0.08},
	...
	class SupplyDrop: Default {
		...
		lootType[] = {
			...
			{ "bulk_ItemSandbag", "magazine", 0.05 },
