...
class DisplaytextBoxx50 {
	...
	onLoad = "[] execVM 'scripts\list_textBoxx50.sqf'";
	...
	class controls {
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.225; h = 0.06;
			text = "Не принимаю";
			onButtonClick = "closeDialog 0;[] execVM 'scripts\exit_from_server.sqf'";
		};	
		class RecruitButton1: HW_RscGUIShortcutButton {
			x = 0.61; y = 1.08;
			w = 0.225; h = 0.06;
			text = "Принимаю";
...
class DisplaytextBoxx100 {
	...
	movingEnable = true;
	enableSimulation = true;
	onLoad = "[] execVM 'scripts\list_textBoxx100.sqf'";
...
class DisplaytextBoxx150 {
	...
	movingEnable = true;
	enableSimulation = true;
	onLoad = "[] execVM 'scripts\list_textBoxx150.sqf'";
